...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_tsqw1r2', 'template_vpd91nu', form.current, 'wp86Ig-qRQiPyjTJq')
      .then(
        (result) => {
  ...
  return (
    <div id='contact' className='pt-5 lg:pt-9 pb-10 bg-gradient-to-t from-slate-100'>
      <div className='mx-[1rem] lg:mx-[15rem] flex flex-col justify-center items-center mb-2 md:mb-4'>
        ...
        <p className='md:text-xl md:w-[40rem] text-center'>
          Ready to take your web projects to the next <span className='text-purple-900'>level?</span> <br />
          Let's collaborate and create exceptional user experiences together. <br />
          Contact me now and let's discuss how I can contribute to your frontend development needs.
            ...
            <div className='flex flex-col gap-2'>
              <div className='flex flex-col'>
                ...
                <input
                  ...
                  name="user_name"
                  placeholder="Name"
                  className='p-1 border-2 border-gray-400 rounded w-[20rem] md:w-[25rem]'
                />
              ...
              <div className='flex flex-col'>
                ...
                <input
                  ...
                  name="user_email"
                  placeholder="Email"
                  className='p-1 rounded border-2 border-gray-400 w-[20rem] md:w-[25rem]'
                />
              ...
              <div className='flex flex-col'>
                ...
                <textarea
                  ...
                  className='p-1 border-2 border-gray-400 rounded w-[20rem] md:w-[25rem] h-[8rem]'
                />
              ...
              <input
                type="submit"
                value="Send"
                className='py-1 rounded border-4 shadow-xl border-purple-900 w-[20rem] md:w-[25rem] font-bold hover:bg-slate-700 hover:text-white hover:border-none hover:py-2 hover:px-4 cursor-pointer mt-1 text-purple-900'
              />
              {statusMessage && <p className='text-green-600 font-medium mt-2'>{statusMessage}</p>}
            </div>
          </form>
        </div>
      </div>
