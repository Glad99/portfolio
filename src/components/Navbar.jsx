...
const Navbar = () => {
    ...
    return (
        <div className="navbar flex gap-20 md:gap-48 lg:justify-between py-3 px-8 lg:px-32 fixed w-full z-50 font-bold bg-white dark:bg-gray-900 shadow-lg">
            ...
            {show ? (
                <AiOutlineClose onClick={() => setShow(prev => !prev)} className='menu-icon text-3xl lg:hidden text-purple-900 dark:text-white p-1 border rounded border-white shadow-lg dark:border-white z-50 fixed right-8' />
            ) : (
