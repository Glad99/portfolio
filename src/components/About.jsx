...
const About = () => {
  return (
    <div id='about' className='pt-3 md:pt-24 bg-gray-100 rounded-tr-full rounded-bl-full  '>
     ...
     <a href="https://drive.google.com/file/d/1nCLkTLikYwSKVejwbnUt4am1u9CRTs8E/view"> <motion.button className='px-3 py-2 mt-10 text-lg font-semibold rounded border-4  border-solid border-purple-900 text-purple-900 shadow-xl hover:bg-slate-700 hover:text-white hover:border-none hover:py-3 hover:px-4'
      initial={{x: '-100vw'}}
      animate={{x: 0}}
